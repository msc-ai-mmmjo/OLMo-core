...
def plot_results(results, output_dir):
    ...
    plot_histogram_kde(ax_ttft, results["hydra"]["ttft"]["filtered_ms"], "Hydra", "tab:blue")
    if "baseline" in results:
        plot_histogram_kde(ax_ttft, results["baseline"]["ttft"]["filtered_ms"], "Baseline", "tab:orange")
    ax_ttft.set_title("TTFT Distribution")
    ax_ttft.legend()

    plot_decode_curve(ax_latency, ax_tps, results["hydra"]["decode"], "Hydra", "tab:blue")
    if "baseline" in results:
        plot_decode_curve(ax_latency, ax_tps, results["baseline"]["decode"], "Baseline", "tab:orange")
